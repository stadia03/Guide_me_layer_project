...
import landingImg from '../../Assets/wave_1.svg'
...
const Chat = ({ platform, questionTitleClass, questionBodyClass }) => {
    ...
    async function processMessageChatgpt(chatMessages) {
        ...
        const sytstemMsgContent = `Your name is "Guidee". You are "Guidee". Identify yourself as "Guidee". I will call you that. I'm a student preparing for software engineering interviews. I'm currently trying the
        ${questionTitle} question on ${platform}. Here is the full description of the question: 
        ${questionData}. My preferred programming language is ${prefferedLanguage}. You will help me with my doubts related to this question. You must not answer anything that is not relevant to the question or to my interview preparation. This is very important. Remember your name is "Guidee"`
        const systemMessage = {
            role: "system",
                ...
                <>
                    {!messages || (messages && messages.length === 0) ?
                        <div className="chat-welcome-msg">
                            <div>
                                <img src={landingImg} alt="Guidee"  />
                            </div>
                            <div>
                                <h3>Hi there! Welcome to<span className="color-primary"> Guide Me</span></h3>
